...
clear all;
data = importdata('D:\FPGA_MATLAB_Learning\CIC_Filter\波形生成\Bit_Stream_Sweep_3015_T0.66.txt');
...
fid = fopen('D:\FPGA_MATLAB_Learning\CIC_Filter\波形生成\Bit_Stream_Sweep_3015__T0.66Cov.txt','wt');
fprintf(fid,'%d\n',output);       % \n 换行
fclose(fid);
% % 可以选择将数据保存到另一个文件中
